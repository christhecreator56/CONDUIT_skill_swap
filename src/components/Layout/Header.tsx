          ...
          <div className="relative">
            <div className="flex items-center space-x-3">
              {user?.profilePhoto ? (
                ...
                <div className="h-9 w-9 bg-primary-100 rounded-full flex items-center justify-center ring-2 ring-white/40 hover:ring-white/60 transition-all duration-200 shadow-sm">
